  ...
  if (sent) {
    return (
      <View style={styles.container}>
        <FigmaHeader title="Add Friend" onBack={() => router.replace('/(tabs)/friends')} />
        <View style={styles.successContent}>
          <Text style={styles.successTitle}>Sent!</Text>
          <Text style={styles.successSub}>Friend request sent to</Text>
          <Text style={styles.successName}>{username.trim()}</Text>
          <TouchableOpacity style={styles.btn} onPress={() => router.replace('/(tabs)/friends')}>
...
const styles = StyleSheet.create({
  ...
  label: { fontFamily: 'Dokdo_400Regular', fontSize: 28, color: '#000000' },
  inputBox: { borderWidth: 2, borderRadius: 12, backgroundColor: '#f8f8f8', paddingHorizontal: 16 },
  input: { fontFamily: 'Agdasima_400Regular', fontSize: 20, color: '#000000', paddingVertical: 14 },
  errorMsg: { fontFamily: 'Agdasima_400Regular', fontSize: 14, color: '#ff7ac1' },
  ...
  cancelText: { fontFamily: 'Agdasima_400Regular', fontSize: 16, color: '#a7a7a7', textAlign: 'center', paddingVertical: 8 },
  successContent: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32, gap: 12 },
  successTitle: { fontFamily: 'Dokdo_400Regular', fontSize: 64, color: '#000000' },
  successSub: { fontFamily: 'Agdasima_400Regular', fontSize: 18, color: '#a7a7a7' },
  successName: { fontFamily: 'Dokdo_400Regular', fontSize: 32, color: '#000000' },
});
