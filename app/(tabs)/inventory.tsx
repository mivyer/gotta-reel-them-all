...
export default function InventoryScreen() {
  ...
  const handleConfirmRelease = () => {
    ...
    router.push({ pathname: "/release/wild-post", params: { color: selectedReel.color } });
  };
      ...
      <Modal visible={modalVisible} transparent={true}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            {selectedReel && (
              <View>
                <Text style={{ textAlign: "center", fontSize: 30, fontFamily: "Dokdo_400Regular" }}>
                  Your Bug Reel:
                </Text>
                ...
                <Text style={{ textAlign: "left", fontSize: 20, fontFamily: "Agdasima_400Regular" }}>
