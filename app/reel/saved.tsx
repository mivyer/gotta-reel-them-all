...
export default function SavedReelScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <FigmaHeader
        title={isBlue ? 'Blue Reel' : 'Pink Reel'}
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoCard}>
          ...
          <InfoRow label="Type" value={isBlue ? 'Blue' : 'Pink'} />
...
const styles = StyleSheet.create({
  ...
  reelName: { fontFamily: 'Agdasima_400Regular', fontSize: 22, color: '#000000' },
  ...
  infoLabel: { fontFamily: 'Agdasima_400Regular', fontSize: 16, color: '#a7a7a7' },
  infoValue: { fontFamily: 'Agdasima_400Regular', fontSize: 16, color: '#000000' },
  ...
  ghostBtnText: { fontFamily: 'Agdasima_400Regular', fontSize: 16, color: '#a7a7a7' },
