...
export default function SentReelScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <FigmaHeader title="SENT!" onBack={() => router.replace('/(tabs)/friends')} />
...
const styles = StyleSheet.create({
  ...
  sentTitle: { fontFamily: 'Dokdo_400Regular', fontSize: 64, color: '#000000' },
  sentSub: { fontFamily: 'Agdasima_400Regular', fontSize: 18, color: '#a7a7a7' },
  friendName: { fontFamily: 'Dokdo_400Regular', fontSize: 32, color: '#000000' },
  card: {
    width: '100%', backgroundColor: '#f8f8f8', borderRadius: 16,
    padding: 20, gap: 6, marginVertical: 8,
  },
  cardLabel: { fontFamily: 'Dokdo_400Regular', fontSize: 22, color: '#000000' },
  cardDetail: { fontFamily: 'Agdasima_400Regular', fontSize: 16, color: '#a7a7a7' },
